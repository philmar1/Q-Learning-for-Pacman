...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        ##Define a Qvalue function or something
    ...
    """
        ...
        possibleRewards = util.Counter()
        for action in legalActions :
        possibleRewards[action] = self.getQValue[(state,action)]
        action = possibleRewards.argMax()
        return action
    """
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
            ...
            print("feature=",self.getFeature(state,action))
            #self.Qvalues[(state,action) = np.dot(self.getWeights,self.getFeature(state,action)
            return(self.Qvalues[(state,action)])"""
